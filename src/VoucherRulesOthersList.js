...
class VoucherRulesOthersList extends Component {
    ...
    componentDidMount() {
        ...
        fetch('/vouplaVoucherRulesOthers/search/customSearchWithFilter?sort=desc')
            .then(response => response.json())
            .then(data => this.setState({voucherRulesOthers: data["_embedded"]["vouplaVoucherRulesOthers"], isLoading: false}));
    }

    async remove(id) {
        await fetch(`/vouplaVoucherRulesOthers/${id}`, {
            method: 'DELETE',
            headers: {
            ...
            let updatedVoucherRulesOthers = [...this.state.voucherRulesOthers].filter(i => i.otherRuleId !== id);
            this.setState({voucherRulesOthers: updatedVoucherRulesOthers});
        });
    }
            ...
            return <tr key={voucherRuleOther.otherRuleId}>
                <td>
                    <ButtonGroup>
                        ...
                        <Button size="sm" color="danger" onClick={() => this.remove(voucherRuleOther.otherRuleId)}>
